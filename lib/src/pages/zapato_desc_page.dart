...
import 'package:nike_app/src/widgets/custom_widgets.dart';
...
class _BotonSombreado extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: 55,
      height: 55,
      decoration: BoxDecoration(color: Colors.white, shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.black12, spreadRadius: -5, blurRadius: 20, offset: Offset(0, 10))]),
    );
  }
}
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            Spacer(),
            Bounce(delay: Duration(seconds: 1), from: 8, child: BotonNaranja(texto: 'Buy now', ancho: 120, alto: 40))
          ],
        ),
      ),
    );
